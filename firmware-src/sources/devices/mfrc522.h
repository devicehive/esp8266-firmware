 ...
 * Translate to C language and adapted for ESP8266 by Nikolay Khabarov
...
RO_DATA uint8_t MFRC522_firmware_referenceV0_0[] = {
...
RO_DATA uint8_t MFRC522_firmware_referenceV1_0[] = {
...
// Version 2.0 (0x92)
// NXP Semiconductors; Rev. 3.8 - 17 September 2014; 16.1.1 self-test
RO_DATA uint8_t MFRC522_firmware_referenceV2_0[] = {
...
RO_DATA uint8_t FM17522_firmware_reference[] = {
...
#define FIFO_SIZE 64		// The FIFO is 64 uint8_ts.

/////////////////////////////////////////////////////////////////////////////////////
// Functions for setting up ESP8266
/////////////////////////////////////////////////////////////////////////////////////
MFRC522_StatusCode MFRC522_Set_CS(int pin);
MFRC522_Uid *MFRC522_Get_Uid();

/////////////////////////////////////////////////////////////////////////////////////
// Basic interface functions for communicating with the MFRC522
/////////////////////////////////////////////////////////////////////////////////////
void MFRC522_PCD_WriteRegister(uint8_t reg, uint8_t value);
void MFRC522_PCD_WriteRegister_n(uint8_t reg, uint8_t count, uint8_t *values);
uint8_t MFRC522_PCD_ReadRegister(uint8_t reg);
void MFRC522_PCD_ReadRegister_n(uint8_t reg, uint8_t count, uint8_t *values, uint8_t rxAlign);
void MFRC522_setBitMask(unsigned char reg, unsigned char mask);
void MFRC522_PCD_SetRegisterBitMask(uint8_t reg, uint8_t mask);
void MFRC522_PCD_ClearRegisterBitMask(uint8_t reg, uint8_t mask);
...
/////////////////////////////////////////////////////////////////////////////////////
MFRC522_StatusCode MFRC522_PCD_TransceiveData(uint8_t *sendData, uint8_t sendLen, uint8_t *backData, uint8_t *backLen, uint8_t *validBits, uint8_t rxAlign, bool checkCRC);
MFRC522_StatusCode MFRC522_PCD_CommunicateWithPICC(uint8_t command, uint8_t waitIRq, uint8_t *sendData, uint8_t sendLen, uint8_t *backData, uint8_t *backLen, uint8_t *validBits, uint8_t rxAlign, bool checkCRC);
...
MFRC522_StatusCode MFRC522_PICC_Select(MFRC522_Uid *uid, uint8_t validBits);
MFRC522_StatusCode MFRC522_PICC_HaltA();

/////////////////////////////////////////////////////////////////////////////////////
// Functions for communicating with MIFARE PICCs
/////////////////////////////////////////////////////////////////////////////////////
MFRC522_StatusCode MFRC522_PCD_Authenticate(uint8_t command, uint8_t blockAddr, MIFARE_Key *key, MFRC522_Uid *uid);
...
// Support functions
/////////////////////////////////////////////////////////////////////////////////////
MFRC522_StatusCode MFRC522_PCD_MIFARE_Transceive(uint8_t *sendData, uint8_t sendLen, bool acceptTimeout);
// old function used too much memory, now name moved to flash; if you need char, copy from flash to memory
//const char *GetStatusCodeName(uint8_t code);
const char *MFRC522_GetStatusCodeName(MFRC522_StatusCode code);
MFRC522_PICC_Type MFRC522_PICC_GetType(uint8_t sak);
// old function used too much memory, now name moved to flash; if you need char, copy from flash to memory
//const char *PICC_GetTypeName(uint8_t type);
const char *MFRC522_PICC_GetTypeName(MFRC522_PICC_Type type);

// Support functions for debuging
void MFRC522_PCD_DumpVersionToSerial();
void MFRC522_PICC_DumpToSerial(MFRC522_Uid *uid);
void MFRC522_PICC_DumpDetailsToSerial(MFRC522_Uid *uid);
void MFRC522_PICC_DumpMifareClassicToSerial(MFRC522_Uid *uid, MFRC522_PICC_Type piccType, MIFARE_Key *key);
void MFRC522_PICC_DumpMifareClassicSectorToSerial(MFRC522_Uid *uid, MIFARE_Key *key, uint8_t sector);
