...
> ```shell
> curl -H 'Authorization: Bearer eiMfp26Z+yRhiAafXWHCXT0LofwehgikmtygI6XoXIE=' -H 'Content-Type: application/json' -d
> '{"command":"gpio/write","parameters":{"1":0}}' http://nn8571.pg.devicehive.com/api/device/astaff/command
> ```
